...
export default function renderOjos() {
  ...
  app.innerHTML = `
    <section id="ojos-section">
      <h1 id="titulo-ojos">¡Acabamos!</h1>
      <h2 id="subtitulo-ojos">Que tu mirada hable por sí sola</h2>
      <form id="eyeColorForm">
        <label id="label-marron" ><input type="radio" name="eyeColor" value="Marrones" required /> Marrón</label><br>
        <label id="label-azul" ><input type="radio" name="eyeColor" value="Azules" /> Azul</label><br>
        <label id="label-verde"><input type="radio" name="eyeColor" value="Verdes" /> Verde</label><br>
        <label id="label-negro"><input type="radio" name="eyeColor" value="Negros" /> Gris</label><br>
